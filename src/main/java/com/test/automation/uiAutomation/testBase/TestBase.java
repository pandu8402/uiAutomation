...
import com.test.automation.uiAutomation.helper.wait.WaitHelper;
...
public class TestBase {
	...
	public void loadPropertiesFile() throws IOException{
		...
		f1 = new File(System.getProperty("user.dir")+"/src/main/java/com/test/automation/uiAutomation/properties/homepage.properties");
		file = new FileInputStream(f1);
		OR.load(file);
	...
	public String getScreenShot(String imageName) throws IOException{
		...
		String imagelocation = System.getProperty("user.dir")+"/src/main/java/com/test/automation/uiAutomation/screenshot/";
		Calendar calendar = Calendar.getInstance();
		SimpleDateFormat formater = new SimpleDateFormat("dd_MM_yyyy_hh_mm_ss");
	...
	/*public String[][] getData(String excelName, String sheetName){
		System.out.println(System.getProperty("user.dir"));
		String excellocation = System.getProperty("user.dir")+"/src/main/java/com/test/automation/uiAutomation/data/"+excelName;
